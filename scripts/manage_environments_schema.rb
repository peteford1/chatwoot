...
# Environment Management Script for Chatwoot (Schema-based)
...
class EnvironmentManager
  ...
  def check_deployment_status(env_name)
    ...
    if $?.success?
      ...
      puts "💡 Run: ruby scripts/manage_environments_schema.rb --create #{env_name}"
    end
  end
end
...
OptionParser.new do |opts|
  opts.banner = "Usage: ruby scripts/manage_environments_schema.rb [options]"
