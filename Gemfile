...
gem 'azure-storage-blob', git: 'https://github.com/peteford1/azure-storage-ruby', branch: 'chatwoot', require: false
...
gem 'devise', '>= 4.9.4'
gem 'devise-secure_password', git: 'https://github.com/peteford1/devise-secure_password', branch: 'chatwoot'
