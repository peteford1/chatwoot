...
# Created: 2025-06-10 08:23:00 PDT
...
puts "🧹 Starting Account Cleanup Process"
puts "📅 Date: #{Time.now}"
...
# Step 3: Confirmation
puts ""
puts "⚠️  WARNING: This will permanently delete #{accounts_to_delete.size} accounts!"
puts "💾 Backup created at: #{backup_file}"
puts ""
print "Are you sure you want to proceed? (yes/no): "

# For automated execution, comment out the confirmation
